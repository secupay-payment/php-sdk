...
use Secupay\Sdk\Model\AuthenticatedCardRequest;
use Secupay\Sdk\Model\AuthenticatedCardDataCreate;
...
class Constants
{
     ...
     * @var int
     */
    public static int $spaceId = 65992;

    /**
     * @var int
     */
    public static int $userId = 123802;

    /**
     * @var string
     */
    public static string $authenticationKey = 'hl4VfNqRhGjn4/FNxgdz5gjp428djSzlwnh9r27y50Q=';
     ...
     * @var int
     */
    public static int $testCardPaymentMethodConfigurationId = 340882;
