...
use Secupay\Sdk\Service\PaymentMethodService;
...
final class ApiClientTest extends TestCase
{
    ...
    {
        putenv('SCP_HTTP_CLIENT=' . HttpClientFactory::TYPE_CURL);
        $this->assertEquals(HttpClientFactory::getClient(HttpClientFactory::TYPE_CURL), HttpClientFactory::getClient());
        
        putenv('SCP_HTTP_CLIENT=' . HttpClientFactory::TYPE_SOCKET);
    ...
    public function testSdkHeaders()
    {
        ...
        $this->assertEquals($headers['x-meta-sdk-version'], "4.9.0");
        $this->assertEquals($headers['x-meta-sdk-language'], 'php');
        $this->assertEquals($headers['x-meta-sdk-provider'], "Secupay");
    ...
    {
        $languageService = $this->apiClient->getLanguageService();
        $languages = $languageService->all();
        $this->assertEquals($languages[56]['iso2Code'], 'en');
    }
