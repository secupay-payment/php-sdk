...
use Secupay\Sdk\Sdk\Service\TransactionsService;
use Secupay\Sdk\Sdk\Configuration;

$applicationUserId = 123802;
$authenticationKey = 'hl4VfNqRhGjn4/FNxgdz5gjp428djSzlwnh9r27y50Q=';
...
Additional Api services documentation: [*link*](https://shopportal.secupay.com/en-us/doc/api/web-service#_services)<br>
Web Api client: [*link*](https://shopportal.secupay.com//api/client)<br>
<details>
  <summary>Click here to see full list of services</summary>
  <br>All URIs are relative to https://shopportal.secupay.com/<br>
...
Additional Api models documentation: [*link*](https://shopportal.secupay.com/en-us/doc/api/web-service#_models)<br>
<details>
...
When working with webhooks, the `SecupaySdkException` may throw error codes to help with debugging.
