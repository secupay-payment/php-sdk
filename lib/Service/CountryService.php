...
class CountryService {
	 ...
	 * @return \Secupay\Sdk\Model\RestCountry[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			...
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Secupay\Sdk\Model\RestCountry[]', $response->getHeaders()));
