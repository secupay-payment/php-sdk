...
class DocumentTemplateTypesService
{
     ...
     * @return \Secupay\Sdk\Model\DocumentTemplateTypeListResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Secupay\Sdk\Model\DocumentTemplateTypeListResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDocumentTemplatesTypesWithHttpInfo($after = null, $before = null, $expand = null, $limit = null, $order = null, string $contentType = self::contentTypes['getDocumentTemplatesTypes'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Secupay\Sdk\Model\DocumentTemplateTypeListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Secupay\Sdk\Model\DocumentTemplateTypeListResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Secupay\Sdk\Model\DocumentTemplateTypeListResponse', []),
            ...
            $returnType = '\Secupay\Sdk\Model\DocumentTemplateTypeListResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Secupay\Sdk\Model\DocumentTemplateTypeListResponse',
     ...
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Secupay\Sdk\Model\DocumentTemplateType|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Secupay\Sdk\Model\DocumentTemplateType|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getDocumentTemplatesTypesIdWithHttpInfo($id, $expand = null, string $contentType = self::contentTypes['getDocumentTemplatesTypesId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Secupay\Sdk\Model\DocumentTemplateType' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Secupay\Sdk\Model\DocumentTemplateType' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Secupay\Sdk\Model\DocumentTemplateType', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Secupay\Sdk\Model\DocumentTemplateType';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Secupay\Sdk\Model\DocumentTemplateType',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getDocumentTemplatesTypesSearchWithHttpInfo($expand = null, $limit = null, $offset = null, $order = null, $query = null, string $contentType = self::contentTypes['getDocumentTemplatesTypesSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Secupay\Sdk\Model\DocumentTemplateTypeSearchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Secupay\Sdk\Model\DocumentTemplateTypeSearchResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Secupay\Sdk\Model\DocumentTemplateTypeSearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Secupay\Sdk\Model\DocumentTemplateTypeSearchResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Secupay\Sdk\Model\DocumentTemplateTypeSearchResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
