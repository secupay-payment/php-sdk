...
/**
 * DunningCaseLevelService service
 *
 * @category Class
 * @package  Secupay\Sdk
 * @author   Secupay AG.
...
class DunningCaseLevelService {
	...
	public function countWithHttpInfo($space_id, $filter = null) {
		...
		// path params
		$resourcePath = '/dunning-case-level/count';
	 ...
	 * @throws \Secupay\Sdk\VersioningException
	 * @throws \Secupay\Sdk\Http\ConnectionException
	 * @return \Secupay\Sdk\Model\DunningCaseLevel
	 */
	...
	public function readWithHttpInfo($space_id, $id) {
		...
		// path params
		$resourcePath = '/dunning-case-level/read';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
		...
		try {
			$response = $this->apiClient->callApi(
				...
				$httpBody,
				$headerParams,
				'\Secupay\Sdk\Model\DunningCaseLevel',
				'/dunning-case-level/read'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Secupay\Sdk\Model\DunningCaseLevel', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Secupay\Sdk\Model\EntityQuery $query Query restricting the returned dunning case levels. (required)
	 * @throws \Secupay\Sdk\ApiException
	 * @throws \Secupay\Sdk\VersioningException
	 * @throws \Secupay\Sdk\Http\ConnectionException
	 * @return \Secupay\Sdk\Model\DunningCaseLevel[]
	...
	public function searchWithHttpInfo($space_id, $query) {
		...
		// path params
		$resourcePath = '/dunning-case-level/search';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
