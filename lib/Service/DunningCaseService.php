...
class DunningCaseService {
	...
	public function countWithHttpInfo($space_id, $filter = null) {
		...
		// path params
		$resourcePath = '/dunning-case/count';
	 ...
	 */
	public function createFromInvoice($space_id, $invoice_id) {
		return $this->createFromInvoiceWithHttpInfo($space_id, $invoice_id)->getData();
	}

	/**
	 * Operation createFromInvoiceWithHttpInfo
	 *
	 * Create Dunning Case
	 ...
	 * @return ApiResponse
	 */
	public function createFromInvoiceWithHttpInfo($space_id, $invoice_id) {
		// verify the required parameter 'space_id' is set
		if (is_null($space_id)) {
			throw new \InvalidArgumentException('Missing the required parameter $space_id when calling createFromInvoice');
		}
		// verify the required parameter 'invoice_id' is set
		if (is_null($invoice_id)) {
			throw new \InvalidArgumentException('Missing the required parameter $invoice_id when calling createFromInvoice');
		}
		// header params
		$headerParams = [];
		$headerAccept = $this->apiClient->selectHeaderAccept(['application/json;charset=utf-8']);
		...
		// path params
		$resourcePath = '/dunning-case/create-from-invoice';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
		...
		try {
			$response = $this->apiClient->callApi(
				...
				'/dunning-case/create-from-invoice'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Secupay\Sdk\Model\DunningCase', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
	...
	public function readWithHttpInfo($space_id, $id) {
		...
		// path params
		$resourcePath = '/dunning-case/read';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Secupay\Sdk\Model\EntityQuery $query Query restricting the returned dunning cases. (required)
	 * @throws \Secupay\Sdk\ApiException
	 * @throws \Secupay\Sdk\VersioningException
	 * @throws \Secupay\Sdk\Http\ConnectionException
	 * @return \Secupay\Sdk\Model\DunningCase[]
	...
	public function searchWithHttpInfo($space_id, $query) {
		...
		// path params
		$resourcePath = '/dunning-case/search';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
	 ...
	 * @param \DateTime $planned_end_date Optional planned end date of the suspension. (optional)
	 * @throws \Secupay\Sdk\ApiException
	 * @throws \Secupay\Sdk\VersioningException
	 * @throws \Secupay\Sdk\Http\ConnectionException
	 * @return void
	 */
	public function suspend($space_id, $id, $planned_end_date = null) {
		return $this->suspendWithHttpInfo($space_id, $id, $planned_end_date)->getData();
	}
	 ...
	 * @return ApiResponse
	 */
	public function suspendWithHttpInfo($space_id, $id, $planned_end_date = null) {
		// verify the required parameter 'space_id' is set
		if (is_null($space_id)) {
		...
		// verify the required parameter 'id' is set
		if (is_null($id)) {
			throw new \InvalidArgumentException('Missing the required parameter $id when calling suspend');
		}
		// header params
		$headerParams = [];
		$headerAccept = $this->apiClient->selectHeaderAccept(['application/json;charset=utf-8']);
		...
		if (!is_null($planned_end_date)) {
			$queryParams['plannedEndDate'] = $this->apiClient->getSerializer()->toQueryValue($planned_end_date);
		}

		// path params
		$resourcePath = '/dunning-case/suspend';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
