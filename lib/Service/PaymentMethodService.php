...
class PaymentMethodService {
	 ...
	 * @return \Secupay\Sdk\Model\PaymentMethod[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			...
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Secupay\Sdk\Model\PaymentMethod[]', $response->getHeaders()));
