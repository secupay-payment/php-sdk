...
class CountryStateService {
	 ...
	 * @return \Secupay\Sdk\Model\RestCountryState[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			...
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Secupay\Sdk\Model\RestCountryState[]', $response->getHeaders()));
