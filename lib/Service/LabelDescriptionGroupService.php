...
class LabelDescriptionGroupService {
	 ...
	 * @return \Secupay\Sdk\Model\LabelDescriptorGroup[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			...
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Secupay\Sdk\Model\LabelDescriptorGroup[]', $response->getHeaders()));
