...
class PaymentConnectorService {
	 ...
	 * @return \Secupay\Sdk\Model\PaymentConnector[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			...
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Secupay\Sdk\Model\PaymentConnector[]', $response->getHeaders()));
