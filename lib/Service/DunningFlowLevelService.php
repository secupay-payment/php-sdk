...
/**
 * DunningFlowLevelService service
 *
 * @category Class
 * @package  Secupay\Sdk
 * @author   Secupay AG.
...
class DunningFlowLevelService {
	...
	public function countWithHttpInfo($space_id, $filter = null) {
		...
		// path params
		$resourcePath = '/dunning-flow-level/count';
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param int $id The id of the dunning flow level which should be returned. (required)
	 * @throws \Secupay\Sdk\ApiException
	 * @throws \Secupay\Sdk\VersioningException
	 * @throws \Secupay\Sdk\Http\ConnectionException
	...
	public function readWithHttpInfo($space_id, $id) {
		...
		// path params
		$resourcePath = '/dunning-flow-level/read';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
		...
		try {
			$response = $this->apiClient->callApi(
				...
				'/dunning-flow-level/read'
            );
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Secupay\Sdk\Model\DunningFlowLevel', $response->getHeaders()));
		} catch (ApiException $e) {
			switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Secupay\Sdk\Model\EntityQuery $query Query restricting the returned dunning flow levels. (required)
	 * @throws \Secupay\Sdk\ApiException
	 * @throws \Secupay\Sdk\VersioningException
	 * @throws \Secupay\Sdk\Http\ConnectionException
	 * @return \Secupay\Sdk\Model\DunningFlowLevel[]
	...
	public function searchWithHttpInfo($space_id, $query) {
		...
		// path params
		$resourcePath = '/dunning-flow-level/search';
		// default format to json
		$resourcePath = str_replace('{format}', 'json', $resourcePath);
