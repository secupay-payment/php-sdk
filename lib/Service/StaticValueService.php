...
class StaticValueService {
	 ...
	 * @return \Secupay\Sdk\Model\StaticValue[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			...
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Secupay\Sdk\Model\StaticValue[]', $response->getHeaders()));
