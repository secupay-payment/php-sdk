...
class DocumentTemplateTypeService {
	 ...
	 * @return \Secupay\Sdk\Model\DocumentTemplateType[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			...
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Secupay\Sdk\Model\DocumentTemplateType[]', $response->getHeaders()));
