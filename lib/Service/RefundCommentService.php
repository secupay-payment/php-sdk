...
class RefundCommentService {
	 ...
	 * @return \Secupay\Sdk\Model\RefundComment[]
	 */
	...
	public function allWithHttpInfo($space_id, $refund_id) {
		...
		try {
			...
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Secupay\Sdk\Model\RefundComment[]', $response->getHeaders()));
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Secupay\Sdk\Model\RefundCommentCreate $entity The comment object which should be created. (required)
	 * @throws \Secupay\Sdk\ApiException
	 * @throws \Secupay\Sdk\VersioningException
	 * @throws \Secupay\Sdk\Http\ConnectionException
	 * @return \Secupay\Sdk\Model\RefundComment
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Secupay\Sdk\Model\RefundCommentActive $entity The comment object with the properties which should be updated. (required)
	 * @throws \Secupay\Sdk\ApiException
	 * @throws \Secupay\Sdk\VersioningException
	 * @throws \Secupay\Sdk\Http\ConnectionException
	 * @return \Secupay\Sdk\Model\RefundComment
