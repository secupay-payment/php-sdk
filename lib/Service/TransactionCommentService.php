...
class TransactionCommentService {
	 ...
	 * @return \Secupay\Sdk\Model\TransactionComment[]
	 */
	...
	public function allWithHttpInfo($space_id, $transaction_id) {
		...
		try {
			...
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Secupay\Sdk\Model\TransactionComment[]', $response->getHeaders()));
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Secupay\Sdk\Model\TransactionCommentCreate $entity The comment object which should be created. (required)
	 * @throws \Secupay\Sdk\ApiException
	 * @throws \Secupay\Sdk\VersioningException
	 * @throws \Secupay\Sdk\Http\ConnectionException
	 * @return \Secupay\Sdk\Model\TransactionComment
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \Secupay\Sdk\Model\TransactionCommentActive $entity The comment object with the properties which should be updated. (required)
	 * @throws \Secupay\Sdk\ApiException
	 * @throws \Secupay\Sdk\VersioningException
	 * @throws \Secupay\Sdk\Http\ConnectionException
	 * @return \Secupay\Sdk\Model\TransactionComment
