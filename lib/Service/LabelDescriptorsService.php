...
class LabelDescriptorsService
{
     ...
     * @return \Secupay\Sdk\Model\LabelDescriptorListResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Secupay\Sdk\Model\LabelDescriptorListResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLabelDescriptorsWithHttpInfo($after = null, $before = null, $expand = null, $limit = null, $order = null, string $contentType = self::contentTypes['getLabelDescriptors'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Secupay\Sdk\Model\LabelDescriptorListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Secupay\Sdk\Model\LabelDescriptorListResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Secupay\Sdk\Model\LabelDescriptorListResponse', []),
            ...
            $returnType = '\Secupay\Sdk\Model\LabelDescriptorListResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Secupay\Sdk\Model\LabelDescriptorListResponse',
     ...
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Secupay\Sdk\Model\LabelDescriptorGroupListResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Secupay\Sdk\Model\LabelDescriptorGroupListResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLabelDescriptorsGroupsWithHttpInfo($after = null, $before = null, $expand = null, $limit = null, $order = null, string $contentType = self::contentTypes['getLabelDescriptorsGroups'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Secupay\Sdk\Model\LabelDescriptorGroupListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Secupay\Sdk\Model\LabelDescriptorGroupListResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Secupay\Sdk\Model\LabelDescriptorGroupListResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Secupay\Sdk\Model\LabelDescriptorGroupListResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Secupay\Sdk\Model\LabelDescriptorGroupListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Secupay\Sdk\Model\LabelDescriptorGroup|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Secupay\Sdk\Model\LabelDescriptorGroup|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLabelDescriptorsGroupsIdWithHttpInfo($id, $expand = null, string $contentType = self::contentTypes['getLabelDescriptorsGroupsId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Secupay\Sdk\Model\LabelDescriptorGroup' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Secupay\Sdk\Model\LabelDescriptorGroup' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Secupay\Sdk\Model\LabelDescriptorGroup', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Secupay\Sdk\Model\LabelDescriptorGroup';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Secupay\Sdk\Model\LabelDescriptorGroup',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Secupay\Sdk\Model\LabelDescriptorGroupSearchResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Secupay\Sdk\Model\LabelDescriptorGroupSearchResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLabelDescriptorsGroupsSearchWithHttpInfo($expand = null, $limit = null, $offset = null, $order = null, $query = null, string $contentType = self::contentTypes['getLabelDescriptorsGroupsSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Secupay\Sdk\Model\LabelDescriptorGroupSearchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Secupay\Sdk\Model\LabelDescriptorGroupSearchResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Secupay\Sdk\Model\LabelDescriptorGroupSearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Secupay\Sdk\Model\LabelDescriptorGroupSearchResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Secupay\Sdk\Model\LabelDescriptorGroupSearchResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Secupay\Sdk\Model\LabelDescriptor|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Secupay\Sdk\Model\LabelDescriptor|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLabelDescriptorsIdWithHttpInfo($id, $expand = null, string $contentType = self::contentTypes['getLabelDescriptorsId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Secupay\Sdk\Model\LabelDescriptor' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Secupay\Sdk\Model\LabelDescriptor' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Secupay\Sdk\Model\LabelDescriptor', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Secupay\Sdk\Model\LabelDescriptor';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Secupay\Sdk\Model\LabelDescriptor',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    public function getLabelDescriptorsSearchWithHttpInfo($expand = null, $limit = null, $offset = null, $order = null, $query = null, string $contentType = self::contentTypes['getLabelDescriptorsSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Secupay\Sdk\Model\LabelDescriptorSearchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Secupay\Sdk\Model\LabelDescriptorSearchResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Secupay\Sdk\Model\LabelDescriptorSearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Secupay\Sdk\Model\LabelDescriptorSearchResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Secupay\Sdk\Model\LabelDescriptorSearchResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
