...
class CustomerAddressesService
{
    ...
    public function getCustomersCustomerIdAddressesWithHttpInfo($customer_id, $space, $after = null, $before = null, $expand = null, $limit = null, $order = null, string $contentType = self::contentTypes['getCustomersCustomerIdAddresses'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Secupay\Sdk\Model\CustomerAddressListResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Secupay\Sdk\Model\CustomerAddressListResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Secupay\Sdk\Model\CustomerAddressListResponse', []),
            ...
            $returnType = '\Secupay\Sdk\Model\CustomerAddressListResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Secupay\Sdk\Model\CustomerAddressListResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Secupay\Sdk\Model\CustomerAddress|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Secupay\Sdk\Model\CustomerAddress|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomersCustomerIdAddressesIdWithHttpInfo($customer_id, $id, $space, $expand = null, string $contentType = self::contentTypes['getCustomersCustomerIdAddressesId'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Secupay\Sdk\Model\CustomerAddress' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Secupay\Sdk\Model\CustomerAddress' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Secupay\Sdk\Model\CustomerAddress', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Secupay\Sdk\Model\CustomerAddress';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Secupay\Sdk\Model\CustomerAddress',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Secupay\Sdk\Model\CustomerAddressSearchResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Secupay\Sdk\Model\CustomerAddressSearchResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCustomersCustomerIdAddressesSearchWithHttpInfo($customer_id, $space, $expand = null, $limit = null, $offset = null, $order = null, $query = null, string $contentType = self::contentTypes['getCustomersCustomerIdAddressesSearch'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Secupay\Sdk\Model\CustomerAddressSearchResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Secupay\Sdk\Model\CustomerAddressSearchResponse' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Secupay\Sdk\Model\CustomerAddressSearchResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
            ...
            $returnType = '\Secupay\Sdk\Model\CustomerAddressSearchResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Secupay\Sdk\Model\CustomerAddressSearchResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  int $id id (required)
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \Secupay\Sdk\Model\CustomerAddressActive $customer_address_active customer_address_active (required)
     * @param  string[] $expand expand (optional)
     ...
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Secupay\Sdk\Model\CustomerAddress|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse
     */
     ...
     * @param  int $id (required)
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \Secupay\Sdk\Model\CustomerAddressActive $customer_address_active (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['patchCustomersCustomerIdAddressesId'] to see the possible values for this operation
     *
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Secupay\Sdk\Model\CustomerAddress|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse|\Secupay\Sdk\Model\RestApiErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  int $customer_id customer_id (required)
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \Secupay\Sdk\Model\CustomerAddressCreate $customer_address_create customer_address_create (required)
     * @param  string[] $expand expand (optional)
     ...
     * @param  int $customer_id (required)
     * @param  int $space Specifies the ID of the space the operation should be executed in. (required)
     * @param  \Secupay\Sdk\Model\CustomerAddressCreate $customer_address_create (required)
     * @param  string[] $expand (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['postCustomersCustomerIdAddresses'] to see the possible values for this operation
     *
     * @throws \Secupay\Sdk\ApiException on non-2xx response or if the response body is not in the expected format
