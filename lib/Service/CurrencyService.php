...
class CurrencyService {
	 ...
	 * @return \Secupay\Sdk\Model\RestCurrency[]
	 */
	public function all() {
	...
	public function allWithHttpInfo() {
		...
		try {
			...
			return new ApiResponse($response->getStatusCode(), $response->getHeaders(), $this->apiClient->getSerializer()->deserialize($response->getData(), '\Secupay\Sdk\Model\RestCurrency[]', $response->getHeaders()));
