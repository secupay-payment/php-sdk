...
class HumanUserListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\HumanUser[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Secupay\Sdk\Model\HumanUser[]|null
     */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\HumanUser[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
