...
class PaymentProcessorConfigurationSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\PaymentProcessorConfiguration[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\PaymentProcessorConfiguration[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
