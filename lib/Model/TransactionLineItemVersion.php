...
class TransactionLineItemVersion implements ModelInterface, ArrayAccess
{
     ...
     * Sets line_items
     *
     * @param \Secupay\Sdk\Model\LineItem[] $line_items The line items that replace the original line items in the transaction.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \Secupay\Sdk\Model\TransactionLineItemVersionState
     */
     ...
     * Sets state
     *
     * @param \Secupay\Sdk\Model\TransactionLineItemVersionState $state The object's current state.
     *
     * @return $this
     */
     ...
     * Sets transaction
     *
     * @param \Secupay\Sdk\Model\Transaction $transaction The transaction that the line item version belongs to.
     *
     * @return $this
     */
