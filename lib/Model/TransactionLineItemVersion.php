...
class TransactionLineItemVersion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'id' => 'int',
        'state' => '\Secupay\Sdk\Model\TransactionLineItemVersionState',
    ...
    */
     ...
     * Sets line_items
     *
     * @param \Secupay\Sdk\Model\LineItem[]|null $line_items The line items that replace the original line items in the transaction.
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \Secupay\Sdk\Model\TransactionLineItemVersionState|null
     */
     ...
     * Sets state
     *
     * @param \Secupay\Sdk\Model\TransactionLineItemVersionState|null $state state
     *
     * @return self
     */
