...
class ChargeFlowLevelPaymentLink implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'charge_flow_level' => '\Secupay\Sdk\Model\ChargeFlowLevel',
        'id' => 'int',
        'linked_space_id' => 'int',
        'payment_link' => 'string'
    ];
     ...
     *
     * @param \Secupay\Sdk\Model\ChargeFlowLevel $charge_flow_level The charge flow level that the payment link belongs to.
     *
     * @return $this
     */
