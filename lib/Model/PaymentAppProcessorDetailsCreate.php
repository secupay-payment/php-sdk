...
class PaymentAppProcessorDetailsCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentAppProcessorDetails.Create';
    ...
    */
    ...
    public function setExternalId($external_id)
    {
        ...
        if ((mb_strlen($external_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $external_id when calling PaymentAppProcessorDetailsCreate., must be smaller than or equal to 40.');
        }
        if ((mb_strlen($external_id) < 1)) {
            throw new \InvalidArgumentException('invalid length for $external_id when calling PaymentAppProcessorDetailsCreate., must be bigger than or equal to 1.');
        }
        if ((!preg_match("/[ \\x20-\\x7e]*/", ObjectSerializer::toString($external_id)))) {
            throw new \InvalidArgumentException("invalid value for \$external_id when calling PaymentAppProcessorDetailsCreate., must conform to the pattern /[ \\x20-\\x7e]*/.");
        }
