...
class ChargeAttemptListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\ChargeAttempt[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Secupay\Sdk\Model\ChargeAttempt[]|null
     */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\ChargeAttempt[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
