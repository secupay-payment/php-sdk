...
class AbstractSpaceUpdate implements ModelInterface, ArrayAccess
{
     ...
     * Gets postal_address
     *
     * @return \Secupay\Sdk\Model\SpaceAddressCreate
     */
     ...
     * Sets postal_address
     *
     * @param \Secupay\Sdk\Model\SpaceAddressCreate $postal_address The address that is used in communication with clients for example in emails, documents, etc.
     *
     * @return $this
     */
