...
class InvoiceReconciliationRecord extends TransactionAwareEntity 
{
    ...
    protected static $swaggerTypes = [
        ...
        'given_name' => 'string',
        'iban' => 'string',
        'last_resolution_failure' => '\Secupay\Sdk\Model\FailureReason',
        ...
        'rejection_status' => '\Secupay\Sdk\Model\InvoiceReconciliationRecordRejectionStatus',
        'resolved_by' => 'int',
        'resolved_on' => '\DateTime',
        'sender_bank_account' => 'string',
        'state' => '\Secupay\Sdk\Model\InvoiceReconciliationRecordState',
        'street' => 'string',
        'type' => '\Secupay\Sdk\Model\InvoiceReconciliationRecordType',
        'unique_id' => 'string',
        'value_date' => '\DateTime',
        'version' => 'int'
    ];
     ...
     *
     * @param \Secupay\Sdk\Model\FailureReason $last_resolution_failure 
     *
     * @return $this
     */
     ...
     *
     * @return \Secupay\Sdk\Model\InvoiceReconciliationRecordRejectionStatus
     */
     ...
     *
     * @param \Secupay\Sdk\Model\InvoiceReconciliationRecordRejectionStatus $rejection_status 
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \Secupay\Sdk\Model\InvoiceReconciliationRecordState
     */
     ...
     * Sets state
     *
     * @param \Secupay\Sdk\Model\InvoiceReconciliationRecordState $state The object's current state.
     *
     * @return $this
     */
     ...
     * Gets type
     *
     * @return \Secupay\Sdk\Model\InvoiceReconciliationRecordType
     */
     ...
     * Sets type
     *
     * @param \Secupay\Sdk\Model\InvoiceReconciliationRecordType $type 
     *
     * @return $this
     */
