...
class PaymentTerminalConfigurationVersion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets configuration
     *
     * @return \Secupay\Sdk\Model\PaymentTerminalConfiguration|null
     */
     ...
     * Sets configuration
     *
     * @param \Secupay\Sdk\Model\PaymentTerminalConfiguration|null $configuration configuration
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \Secupay\Sdk\Model\PaymentTerminalConfigurationVersionState|null
     */
     ...
     * Sets state
     *
     * @param \Secupay\Sdk\Model\PaymentTerminalConfigurationVersionState|null $state state
     *
     * @return self
     */
