...
class TransactionInvoice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'completion' => '\Secupay\Sdk\Model\TransactionCompletion',
        ...
        'id' => 'int',
        'state' => '\Secupay\Sdk\Model\TransactionInvoiceState',
    ...
    */
     ...
     * Gets completion
     *
     * @return \Secupay\Sdk\Model\TransactionCompletion|null
     */
     ...
     * Sets completion
     *
     * @param \Secupay\Sdk\Model\TransactionCompletion|null $completion completion
     *
     * @return self
     */
     ...
     * Sets line_items
     *
     * @param \Secupay\Sdk\Model\LineItem[]|null $line_items The invoiced line items that will appear on the invoice document.
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \Secupay\Sdk\Model\TransactionInvoiceState|null
     */
     ...
     * Sets state
     *
     * @param \Secupay\Sdk\Model\TransactionInvoiceState|null $state state
     *
     * @return self
     */
