...
class TransactionInvoice implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \Secupay\Sdk\Model\Address $billing_address The address associated with the invoice, used for billing purposes.
     *
     * @return $this
     */
     ...
     * Sets completion
     *
     * @param \Secupay\Sdk\Model\TransactionCompletion $completion The transaction completion this object is linked to.
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \Secupay\Sdk\Model\LineItem[] $line_items The invoiced line items that will appear on the invoice document.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \Secupay\Sdk\Model\TransactionInvoiceState
     */
     ...
     * Sets state
     *
     * @param \Secupay\Sdk\Model\TransactionInvoiceState $state The object's current state.
     *
     * @return $this
     */
