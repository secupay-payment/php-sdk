...
class SpaceCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'request_limit' => 'int',
        'postal_address' => '\Secupay\Sdk\Model\SpaceAddressCreate',
        'name' => 'string',
    ...
    */
     ...
     * Gets postal_address
     *
     * @return \Secupay\Sdk\Model\SpaceAddressCreate|null
     */
     ...
     * Sets postal_address
     *
     * @param \Secupay\Sdk\Model\SpaceAddressCreate|null $postal_address postal_address
     *
     * @return self
     */
