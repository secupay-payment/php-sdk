...
class DunningFlowLevelListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\DunningFlowLevel[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Secupay\Sdk\Model\DunningFlowLevel[]|null
     */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\DunningFlowLevel[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
