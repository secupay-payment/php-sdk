...
class WebhookListenerSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\WebhookListener[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Secupay\Sdk\Model\WebhookListener[]|null
     */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\WebhookListener[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
