...
class PaymentContract implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets contract_type
     *
     * @return \Secupay\Sdk\Model\PaymentContractType|null
     */
     ...
     * Sets contract_type
     *
     * @param \Secupay\Sdk\Model\PaymentContractType|null $contract_type contract_type
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \Secupay\Sdk\Model\PaymentContractState|null
     */
     ...
     * Sets state
     *
     * @param \Secupay\Sdk\Model\PaymentContractState|null $state state
     *
     * @return self
     */
     ...
     *
     * @param \Secupay\Sdk\Model\FailureReason|null $rejection_reason rejection_reason
     *
     * @return self
     */
