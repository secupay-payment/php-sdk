...
class TransactionVoidListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\TransactionVoid[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Secupay\Sdk\Model\TransactionVoid[]|null
     */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\TransactionVoid[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
