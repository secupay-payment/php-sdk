...
class TransactionVoid implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'mode' => '\Secupay\Sdk\Model\TransactionVoidMode',
        'linked_space_id' => 'int',
        'timeout_on' => '\DateTime',
        'created_by' => 'int',
        ...
        'id' => 'int',
        'state' => '\Secupay\Sdk\Model\TransactionVoidState',
    ...
    */
     ...
     * Gets mode
     *
     * @return \Secupay\Sdk\Model\TransactionVoidMode|null
     */
     ...
     * Sets mode
     *
     * @param \Secupay\Sdk\Model\TransactionVoidMode|null $mode mode
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \Secupay\Sdk\Model\TransactionVoidState|null
     */
     ...
     * Sets state
     *
     * @param \Secupay\Sdk\Model\TransactionVoidState|null $state state
     *
     * @return self
     */
