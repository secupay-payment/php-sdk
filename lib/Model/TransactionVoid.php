...
class TransactionVoid implements ModelInterface, ArrayAccess
{
     ...
     * Sets failure_reason
     *
     * @param \Secupay\Sdk\Model\FailureReason $failure_reason The reason for the failure of the transaction void.
     *
     * @return $this
     */
     ...
     * Gets mode
     *
     * @return \Secupay\Sdk\Model\TransactionVoidMode
     */
     ...
     * Sets mode
     *
     * @param \Secupay\Sdk\Model\TransactionVoidMode $mode The mode of transaction void, such as online or offline, determining how the void process is executed.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \Secupay\Sdk\Model\TransactionVoidState
     */
     ...
     * Sets state
     *
     * @param \Secupay\Sdk\Model\TransactionVoidState $state The object's current state.
     *
     * @return $this
     */
     ...
     * Sets transaction
     *
     * @param \Secupay\Sdk\Model\Transaction $transaction The transaction that the void belongs to.
     *
     * @return $this
     */
