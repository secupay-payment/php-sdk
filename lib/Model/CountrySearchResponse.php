...
class CountrySearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\RestCountry[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Secupay\Sdk\Model\RestCountry[]|null
     */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\RestCountry[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
