...
class LanguageSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\RestLanguage[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Secupay\Sdk\Model\RestLanguage[]|null
     */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\RestLanguage[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
