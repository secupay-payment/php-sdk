...
class CustomerAddressListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\CustomerAddress[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Secupay\Sdk\Model\CustomerAddress[]|null
     */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\CustomerAddress[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
