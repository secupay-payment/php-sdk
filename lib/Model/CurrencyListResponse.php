...
class CurrencyListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\RestCurrency[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Secupay\Sdk\Model\RestCurrency[]|null
     */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\RestCurrency[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
