...
class PaymentAppChargeAttemptUpdate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentAppChargeAttemptUpdate';
    ...
    protected static array $openAPINullables = [
        ...
        'end_user_failure_message' => false
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('target_state', $data ?? [], null);
        $this->setIfExists('failure_reason', $data ?? [], null);
        $this->setIfExists('end_user_failure_message', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets reference
     *
     * @param string|null $reference A unique identifier for the charge attempt within the systems of the external service provider. This field is mandatory when the target state is set to 'SUCCESSFUL'.
     *
     * @return self
     */
    public function setReference($reference)
    {
        ...
        if ((mb_strlen($reference) > 100)) {
            throw new \InvalidArgumentException('invalid length for $reference when calling PaymentAppChargeAttemptUpdate., must be smaller than or equal to 100.');
        }
        if ((!preg_match("/[ \\x20-\\x7e]*/", ObjectSerializer::toString($reference)))) {
            throw new \InvalidArgumentException("invalid value for \$reference when calling PaymentAppChargeAttemptUpdate., must conform to the pattern /[ \\x20-\\x7e]*/.");
        }
     ...
     * Gets target_state
     *
     * @return \Secupay\Sdk\Model\PaymentAppChargeAttemptTargetState|null
     */
     ...
     * Sets target_state
     *
     * @param \Secupay\Sdk\Model\PaymentAppChargeAttemptTargetState|null $target_state target_state
     *
     * @return self
     */
    public function setTargetState($target_state)
    {
        if (is_null($target_state)) {
            throw new \InvalidArgumentException('non-nullable target_state cannot be null');
        }
     ...
     * Sets failure_reason
     *
     * @param int|null $failure_reason The reason for the charge attempt's failure. This field is mandatory when the target state is set to 'FAILED'.
     *
     * @return self
     */
     ...
     *
     * @param string|null $end_user_failure_message A message explaining to the buyer why the payment failed. The message must be localized in the buyer's language, as specified in the payment page invocation URL.
     *
     * @return self
     */
    public function setEndUserFailureMessage($end_user_failure_message)
    {
        if (is_null($end_user_failure_message)) {
            throw new \InvalidArgumentException('non-nullable end_user_failure_message cannot be null');
        }
        if ((mb_strlen($end_user_failure_message) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $end_user_failure_message when calling PaymentAppChargeAttemptUpdate., must be smaller than or equal to 2000.');
        }
