...
class ManualTask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'type' => 'int',
        'actions' => '\Secupay\Sdk\Model\ManualTaskAction[]',
        'created_on' => '\DateTime'
    ];
    ...
    */
     ...
     * Gets state
     *
     * @return \Secupay\Sdk\Model\ManualTaskState|null
     */
     ...
     * Sets state
     *
     * @param \Secupay\Sdk\Model\ManualTaskState|null $state state
     *
     * @return self
     */
     ...
     * Gets actions
     *
     * @return \Secupay\Sdk\Model\ManualTaskAction[]|null
     */
     ...
     * Sets actions
     *
     * @param \Secupay\Sdk\Model\ManualTaskAction[]|null $actions The actions that can be triggered to handle the manual task.
     *
     * @return self
     */
