...
class PaymentConnectorConfiguration implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @return \Secupay\Sdk\Model\PaymentMethodConfiguration|null
     */
     ...
     *
     * @param \Secupay\Sdk\Model\PaymentMethodConfiguration|null $payment_method_configuration payment_method_configuration
     *
     * @return self
     */
     ...
     *
     * @return \Secupay\Sdk\Model\SalesChannel[]|null
     */
     ...
     *
     * @param \Secupay\Sdk\Model\SalesChannel[]|null $enabled_sales_channels The sales channels for which the connector configuration is enabled. If empty, it is enabled for all sales channels.
     *
     * @return self
     */
     ...
     *
     * @return \Secupay\Sdk\Model\PaymentProcessorConfiguration|null
     */
     ...
     *
     * @param \Secupay\Sdk\Model\PaymentProcessorConfiguration|null $processor_configuration processor_configuration
     *
     * @return self
     */
     ...
     * Gets connector
     *
     * @return \Secupay\Sdk\Model\PaymentConnector|null
     */
     ...
     * Sets connector
     *
     * @param \Secupay\Sdk\Model\PaymentConnector|null $connector connector
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \Secupay\Sdk\Model\CreationEntityState|null
     */
     ...
     * Sets state
     *
     * @param \Secupay\Sdk\Model\CreationEntityState|null $state state
     *
     * @return self
     */
     ...
     * Gets conditions
     *
     * @return \Secupay\Sdk\Model\Condition[]|null
     */
     ...
     * Sets conditions
     *
     * @param \Secupay\Sdk\Model\Condition[]|null $conditions Conditions allow to define criteria that a transaction must fulfill in order for the connector configuration to be considered for processing the payment.
     *
     * @return self
     */
