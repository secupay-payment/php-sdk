...
class SingleSignOnUserSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\SingleSignOnUser[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Secupay\Sdk\Model\SingleSignOnUser[]|null
     */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\SingleSignOnUser[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
