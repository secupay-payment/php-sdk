...
class Space implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets database
     *
     * @return \Secupay\Sdk\Model\TenantDatabase|null
     */
     ...
     * Sets database
     *
     * @param \Secupay\Sdk\Model\TenantDatabase|null $database database
     *
     * @return self
     */
     ...
     * Gets postal_address
     *
     * @return \Secupay\Sdk\Model\SpaceAddress|null
     */
     ...
     * Sets postal_address
     *
     * @param \Secupay\Sdk\Model\SpaceAddress|null $postal_address postal_address
     *
     * @return self
     */
     ...
     * Gets account
     *
     * @return \Secupay\Sdk\Model\Account|null
     */
     ...
     * Sets account
     *
     * @param \Secupay\Sdk\Model\Account|null $account account
     *
     * @return self
     */
