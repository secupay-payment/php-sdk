...
class CustomerEmailAddressListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\RestCustomerEmailAddress[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Secupay\Sdk\Model\RestCustomerEmailAddress[]|null
     */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\RestCustomerEmailAddress[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
