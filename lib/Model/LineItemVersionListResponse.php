...
class LineItemVersionListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\TransactionLineItemVersion[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\TransactionLineItemVersion[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
