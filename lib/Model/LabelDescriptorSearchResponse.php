...
class LabelDescriptorSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\LabelDescriptor[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Secupay\Sdk\Model\LabelDescriptor[]|null
     */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\LabelDescriptor[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
