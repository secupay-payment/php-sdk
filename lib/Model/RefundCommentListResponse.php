...
class RefundCommentListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\RefundComment[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Secupay\Sdk\Model\RefundComment[]|null
     */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\RefundComment[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
