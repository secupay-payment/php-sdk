...
class CustomerCommentListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\CustomerComment[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Secupay\Sdk\Model\CustomerComment[]|null
     */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\CustomerComment[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
