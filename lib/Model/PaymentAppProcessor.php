...
class PaymentAppProcessor implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'configured_environment' => '\Secupay\Sdk\Model\ChargeAttemptEnvironment',
        'created_on' => '\DateTime',
        ...
        'state' => '\Secupay\Sdk\Model\PaymentAppProcessorState',
        'svg_icon' => 'string',
        'updated_on' => '\DateTime',
     ...
     *
     * @param \Secupay\Sdk\Model\ChargeAttemptEnvironment $configured_environment The environment (e.g., test or production) currently configured for the processor.
     *
     * @return $this
     */
     ...
     *
     * @param \Secupay\Sdk\Model\PaymentProcessorConfiguration $processor_configuration The processor configuration created alongside the process within its designated space. This configuration is used in transactions created using this processor.
     *
     * @return $this
     */
     ...
     * Gets state
     *
     * @return \Secupay\Sdk\Model\PaymentAppProcessorState
     */
     ...
     * Sets state
     *
     * @param \Secupay\Sdk\Model\PaymentAppProcessorState $state The object's current state.
     *
     * @return $this
     */
