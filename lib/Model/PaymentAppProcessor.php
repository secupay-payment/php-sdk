...
class PaymentAppProcessor implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param \Secupay\Sdk\Model\ChargeAttemptEnvironment|null $configured_environment configured_environment
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \Secupay\Sdk\Model\PaymentAppProcessorState|null
     */
     ...
     * Sets state
     *
     * @param \Secupay\Sdk\Model\PaymentAppProcessorState|null $state state
     *
     * @return self
     */
