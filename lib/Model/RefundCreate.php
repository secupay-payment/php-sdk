...
class RefundCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets reductions
     *
     * @return \Secupay\Sdk\Model\LineItemReductionCreate[]|null
     */
     ...
     * Sets reductions
     *
     * @param \Secupay\Sdk\Model\LineItemReductionCreate[]|null $reductions The reductions applied on the original transaction items, detailing specific adjustments associated with the refund.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param \Secupay\Sdk\Model\RefundType $type type
     *
     * @return self
     */
