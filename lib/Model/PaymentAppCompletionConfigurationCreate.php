 ...
 */
class PaymentAppCompletionConfigurationCreate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PaymentAppCompletionConfiguration.Create';
