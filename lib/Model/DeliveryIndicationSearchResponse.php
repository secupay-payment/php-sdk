...
class DeliveryIndicationSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\DeliveryIndication[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Secupay\Sdk\Model\DeliveryIndication[]|null
     */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\DeliveryIndication[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
