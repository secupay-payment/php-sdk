...
class InvoiceCommentListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\TransactionInvoiceComment[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Secupay\Sdk\Model\TransactionInvoiceComment[]|null
     */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\TransactionInvoiceComment[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
