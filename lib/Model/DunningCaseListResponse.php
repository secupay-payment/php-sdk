...
class DunningCaseListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\DunningCase[]',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Secupay\Sdk\Model\DunningCase[]|null
     */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\DunningCase[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
