...
class ChargeFlowLevelSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\ChargeFlowLevel[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Gets data
     *
     * @return \Secupay\Sdk\Model\ChargeFlowLevel[]|null
     */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\ChargeFlowLevel[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
