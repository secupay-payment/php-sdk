...
class TransactionCompletionDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'line_items' => '\Secupay\Sdk\Model\CompletionLineItemCreate[]',
    ...
    */
     ...
     * Gets line_items
     *
     * @return \Secupay\Sdk\Model\CompletionLineItemCreate[]|null
     */
     ...
     * Sets line_items
     *
     * @param \Secupay\Sdk\Model\CompletionLineItemCreate[]|null $line_items The line items to be captured in the transaction completion.
     *
     * @return self
     */
