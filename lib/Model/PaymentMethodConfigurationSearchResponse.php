...
class PaymentMethodConfigurationSearchResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'data' => '\Secupay\Sdk\Model\PaymentMethodConfiguration[]',
        'offset' => 'int',
        'has_more' => 'bool',
        'limit' => 'int'
    ];
    ...
    */
     ...
     * Sets data
     *
     * @param \Secupay\Sdk\Model\PaymentMethodConfiguration[]|null $data An array containing the actual response objects.
     *
     * @return self
     */
